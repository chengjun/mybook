...
# - 第三，对于理论的重视不足。目前计算社会科学的发展主要是数据和方法驱动的，对于理论的重视不够是通病。然而这一问题并不容易解决，计算作为一种崭新的范式在理论构建方法还需要进一步的积累。但这种转型背后的理论值得重视，本书将尝试以计算中心（the center of calculation）作为主要的理论视角，强化本书的理论取向。
#  
# 
# ## 致谢
# 
